...
public class BusinessCardv0_5 implements Serializable {
    ...
    // Конструктор
    public BusinessCardv0_5(String userId, String title, String description, String number, String email, String site, String imageUrl, Map<String, String> links, int sample) {
        this.userId = userId;
        this.title = title;
    ...
    // Конструктор
    public BusinessCardv0_5(String cardId, String userId, String title, String description, String number, String email, String site, String imageUrl, Map<String, String> links, int sample, Map<String, String> colors, long views, long favorites) {
